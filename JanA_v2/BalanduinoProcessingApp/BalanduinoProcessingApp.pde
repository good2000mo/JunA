...
void serialEvent(Serial serial) {
  ...
  if (input[0].equals("P") && input.length == 5) { // PID values
    ...
    if (targetAngle.getText().isEmpty())
      targetAngle.setText(stringTargetAngle);
  } else if (input[0].equals("V") && input.length == 10) { // IMU data
    stringAcc = input[1];
    stringGyro = input[2];
    stringKalman = input[3];
    
    String error = input[4];
    String lastError = input[5];
    String pTerm = input[6];
    String iTerm = input[7];
    String dTerm = input[8];
    String PIDValue = input[9];
    
    print(stringAcc);print("\t");
    print(stringKalman);print("\t");
    print(error);print("\t");
    print(lastError);print("\t");
    print(pTerm);print("\t");
    print(iTerm);print("\t");
    print(dTerm);print("\t");
    println(PIDValue);
